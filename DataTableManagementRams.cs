...
namespace Event_Horizon
{
    public class DataTableManagementRams
    {
        ...
        public static List<EventHorizonRamsLINQ> GetEvents(int listViewToPopulate, Int32 eventTypeID, Int32 filterMode, Int32 displayMode, string searchString)
        {
                    ...
                    case DatabaseSystems.AccessMDB:
                        using (OleDbConnection connection = new OleDbConnection(XMLReaderWriter.GlobalConnectionString))
                        {
                            using (var command = new OleDbCommand("UPDATE EventLog SET[EventTypeID] = ?, [SourceID] = ?, [Details] = ?, [FrequencyID] = ?, [StatusID] = ?, [TargetDateTime] = ?, [TargetUserID] = ?, [ReadByMeID] = ?, [LastViewedDateTime] = ?, [RemindMeID] = ?, [RemindMeDateTime] = ?, [NotificationAcknowledged] = ?, [ParentEventID] = ?, [EventModeID] = ?, [EventAttributeID] = ?, [PathFileName] = ?, [UnitCost] = ? , [Qty] = ?, [Discount] = ?, [Stock] = ? WHERE [ID] = ?", connection))
                            {
                                ...
                                command.Parameters.AddWithValue("@EventTypeID", ramsWindow.EventTypeComboBox.SelectedIndex);
                                command.Parameters.AddWithValue("@SourceID", ramsWindow.SourceComboBox.SelectedIndex);
                                command.Parameters.AddWithValue("@Details", detailsSafeString);
                                command.Parameters.AddWithValue("@FrequencyID", ramsWindow.FrequencyComboBox.SelectedIndex);
                                command.Parameters.AddWithValue("@StatusID", ramsWindow.StatusComboBox.SelectedIndex);

                                command.Parameters.Add("TargetDateTime", OleDbType.Date);
                                command.Parameters["TargetDateTime"].Value = targetDateTime;

                                command.Parameters.AddWithValue("@TargetUserID", ramsWindow.TargetUserIDComboBox.SelectedIndex);
                                command.Parameters.AddWithValue("@ReadByMeID", eventHorizonRamsLINQ.ReadByMeID);

                                command.Parameters.Add("LastViewedDateTime", OleDbType.Date);
                                command.Parameters["LastViewedDateTime"].Value = DateTime.MinValue;

                                command.Parameters.AddWithValue("@RemindMeID", eventHorizonRamsLINQ.RemindMeID);

                                command.Parameters.Add("RemindMeDateTime", OleDbType.Date);
                                command.Parameters["RemindMeDateTime"].Value = eventHorizonRamsLINQ.RemindMeDateTime;

                                command.Parameters.AddWithValue("@NotificationAcknowledged", 0);

                                command.Parameters.AddWithValue("@ParentEventID", eventHorizonRamsLINQ.Source_ParentEventID);
                                command.Parameters.AddWithValue("@EventModeID", eventHorizonRamsLINQ.EventModeID);

                                command.Parameters.AddWithValue("@EventAttributeID", eventHorizonRamsLINQ.EventAttributeID);
                                command.Parameters.AddWithValue("@PathFileName", eventHorizonRamsLINQ.PathFileName);
                                command.Parameters.AddWithValue("@UnitCost", eventHorizonRamsLINQ.UnitCost);
                                command.Parameters.AddWithValue("@Qty", eventHorizonRamsLINQ.Qty);
                                command.Parameters.AddWithValue("@Discount", eventHorizonRamsLINQ.Discount);
                                command.Parameters.AddWithValue("@Stock", eventHorizonRamsLINQ.Stock);
                    ...
                    case DatabaseSystems.SQLite:
                        using (SQLiteConnection connection = new SQLiteConnection(XMLReaderWriter.GlobalConnectionString))
                        {
                            using (SQLiteCommand command = new SQLiteCommand("UPDATE EventLog SET EventTypeID = ?, SourceID = ?, Details = ?, FrequencyID = ?, StatusID = ?, TargetDateTime = ?, TargetUserID = ?, ReadByMeID = ?, LastViewedDateTime = ?, RemindMeID = ?, RemindMeDateTime = ?, NotificationAcknowledged = ?, ParentEventID = ?, EventModeID = ?, EventAttributeID = ?, PathFileName = ?, UnitCost = ?, Qty = ?, Discount = ?, Stock = ? WHERE ID = ?", connection))
                            {
                                ...
                                command.Parameters.Add("@EventTypeID", DbType.Int32).Value = ramsWindow.EventTypeComboBox.SelectedIndex;
                                command.Parameters.Add("@SourceID", DbType.Int32).Value = ramsWindow.SourceComboBox.SelectedIndex;
                                command.Parameters.Add("@Details", DbType.String).Value = detailsSafeString;

                                command.Parameters.Add("@FrequencyID", DbType.Int32).Value = ramsWindow.FrequencyComboBox.SelectedIndex;
                                command.Parameters.Add("@StatusID", DbType.Int32).Value = ramsWindow.StatusComboBox.SelectedIndex;

                                command.Parameters.Add("@TargetDateTime", DbType.DateTime).Value = targetDateTime;

                                command.Parameters.Add("@TargetUserID", DbType.Int32).Value = ramsWindow.TargetUserIDComboBox.SelectedIndex;
                                command.Parameters.Add("@ReadByMeID", DbType.Int32).Value = eventHorizonRamsLINQ.ReadByMeID;

                                command.Parameters.Add("@LastViewedDateTime", DbType.DateTime).Value = DateTime.MinValue;

                                command.Parameters.Add("@RemindMeID", DbType.Int32).Value = eventHorizonRamsLINQ.RemindMeID;

                                command.Parameters.Add("@RemindMeDateTime", DbType.DateTime).Value = eventHorizonRamsLINQ.RemindMeDateTime;

                                command.Parameters.Add("@NotificationAcknowledged", DbType.Int32).Value = 0;

                                command.Parameters.Add("@ParentEventID", DbType.Int32).Value = eventHorizonRamsLINQ.Source_ParentEventID;
                                command.Parameters.Add("@EventModeID", DbType.Int32).Value = eventHorizonRamsLINQ.EventModeID;

                                command.Parameters.Add("@EventAttributeID", DbType.Int32).Value = eventHorizonRamsLINQ.EventAttributeID;
                                command.Parameters.Add("@PathFileName", DbType.String).Value = eventHorizonRamsLINQ.PathFileName;
                                command.Parameters.Add("@UnitCost", DbType.Double).Value = eventHorizonRamsLINQ.UnitCost;
                                command.Parameters.Add("@Qty", DbType.Int32).Value = eventHorizonRamsLINQ.Qty;
                                command.Parameters.Add("@Discount", DbType.Double).Value = eventHorizonRamsLINQ.Discount;
                                command.Parameters.Add("@Stock", DbType.Int32).Value = eventHorizonRamsLINQ.Stock;

                                command.Parameters.Add("@ID", DbType.Int32).Value = eventHorizonRamsLINQ.ID;
        ...
        private static bool CheckFormFields(RamsWindow ramsWindow)
        {
            ...
            if (ramsWindow.FrequencyComboBox.SelectedIndex > -1)
            {
                result++;
            }
